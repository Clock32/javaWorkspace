...
public class RockPaperScissors {
	...
	public void rps() {
		...
		if(rps.equals(com)) {
			...
			System.out.println(com[ran]);
			System.out.println("비겼습니다");
			draw++;		
		}else if (rps.equals("가위") && com[ran].equals("바위")
				|| rps.equals("바위") && com[ran].equals("보")
				|| rps.equals("보") && com[ran].equals("가위")){
			
			System.out.println(com[ran]);
			System.out.println("졌습니다.");
			lose++;
		} else if (rps.equals("가위") && com[ran].equals("보")
				|| rps.equals("바위") && com[ran].equals("가위")
				|| rps.equals("보") && com[ran].equals("바위")){
