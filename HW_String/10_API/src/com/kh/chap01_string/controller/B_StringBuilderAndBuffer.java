...
public class B_StringBuilderAndBuffer {
	 ...
	 * 두클래스의 사용방법은 동일하다
	 * 차이점은 동기화 여부
	 * StringBuilder는 동기화를 지원하지 않기때문에 멀티스레드 환경에서 좋은 성능을 보인다
	 * StringBuffer는 동기화를 지원하기 때문에 멀티스레드 환경 에서 스레드 안정설을 보장할 수 있지만
	 * 성능이 좋지 못하다.
	 * 
	 * 대부분은 Builder를 많이 쓴다 성능 ^ 안전성 v
	 * 
	 * 
	 */
	...
	public void method() {
		...
		sb1.append(" World!"); //같은 저장공간에 이어쓰기 가능
		sb1.append("!!!");		//주소값은 1개만 사용
		
		StringBuffer sb2 = new StringBuffer("Hello");
		sb2.append(" World!");
		
		System.out.println(sb1); //toString 이 오버라이드 
