package com.kh.chap01_URL.part02_wep_cralwer;
...
public class WebCralwer {
	...
	/*
	 * URL을 활용한 웹 크롤링
	 * 웹페이지를 탐색하여 HRML내부의 원하는 데이터를 추출하는 작업
	 * 수집한 데이터를 분석하기 위하여 사용한다
	 * 다만 웨[ㅂ페이지의 소유주나 운영자의 러학없이 크롤링시 법적 책임이 따를 수 있다.
	 */
	...
	private void saveFile(List<String> imgList) {
		...
		for(String imgPath : imgList) {
			...
			String savePath = "C:/upload/kh/project/"+fileName;
